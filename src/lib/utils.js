...
import { allMarkers, itemsCollected, points, selectedMarker, settings } from "$lib/stores.js";
...
export const categories = [
  ...
  },
  {
    name: "other",
    label: "Other",
    items: ["cave-entrance", "picnic-basket", "quest-item", "buried-treasure", "present"]
  },
  {
    name: "resource",
    label: "Resources",
