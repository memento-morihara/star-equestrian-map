...
//     document.querySelector("#addButton").addEventListener("click", async function () {
//         let marker = await addMarker(e.latlng.lat, e.latlng.lng, name.value, description.value)
//         locPopup.remove();
//         newMarker(e.latlng, name.value, description.value, marker.id)
//     })
// }
